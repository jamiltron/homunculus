...
public class MainMenu implements Screen, InputProcessor {
  ...
  private void renderText() {
    spriteBatch.draw(Assets.titleRegion, 
        3 * ppuX, 21 * ppuY, 12 * ppuX, 6 * ppuY);
    spriteBatch.draw(Assets.startGameRegion, 
        5 * ppuX, 16 * ppuY, 8 * ppuX, 4 * ppuY);
    spriteBatch.draw(Assets.instructionsRegion, 
        5 * ppuX, 13 * ppuY, 8 * ppuX, 4 * ppuY);
    spriteBatch.draw(Assets.quitRegion, 
        5 * ppuX, 10 * ppuY, 8 * ppuX, 4 * ppuY);
  }
